...
public class AdminDepence {
    ...
    public AdminDepence(int yl_id, int al_id) {
        this.ylem_id = yl_id;
        this.alam_id = al_id;
    }

    public AdminDepence(int yl_id, int al_id, String avaja, String avatud, String muutja, String muudetud, String sulgeja, String suletud) {
        this.ylem_id = yl_id;
        this.alam_id = al_id;
        this.avaja = avaja;
        this.avatud = avatud;
